...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvResult,tvcity,tvResult1,tvResult2,tvResult3,tvResult4,tvResult5,tvResult6;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, tempUrl, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        output1="Temp"+df.format(temp) + " °C";
                        output2 ="Humidity: " + humidity + "%";
                               output3=" Wind Speed: " + wind + "m/s (meters per second)";
                              output4 ="Cloudiness: " + clouds + "%";
                                output5=" Pressure: " + pressure + " hPa";
                         output6 ="Description: " + description;
                      ...
                      /*  tvResult.setTextColor(Color.rgb(68,134,199));
                        ...
                        tvcity.setText(outputC);
                        tvResult.setText(outputW);
